...
describe('Navigation', () => {
  it('should render without errors', () => {
    render(<BrowserRouter><Navigation router={[]} />(</BrowserRouter>);
    ...
    render(
        <BrowserRouter>
            <Navigation router={router}>
                <NavigationItem position='center' label='home' data-testid="home-route" path="/home" />
                <NavigationItem position='center' label='about' data-testid="about-route" path="/about" />
                <NavigationItem position='center' label='contact' data-testid="contact-route" path="/contact" />
            </Navigation>
        </BrowserRouter>
  ...
  it('should not log missing routes if all routes exist in router', () => {
    const mockConsoleLog = jest.spyOn(console, 'log').mockImplementation(() => {});
    const router = [{ path: '/home' }, { path: '/about' }, { path: '/contact' }];
    render(
        <BrowserRouter>
